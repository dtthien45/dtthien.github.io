	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal add-position" method="POST" action="position_add.php">
					...
					<div class="form-group">
						<label for="rate" class="col-sm-3 control-label">Số tiền lương/giờ</label>
...
<div class="modal fade" id="edit">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal edit-position" method="POST" action="position_edit.php">
					...
					<div class="form-group">
						<label for="edit_rate" class="col-sm-3 control-label">Số tiền lương/giờ</label>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-custon-four btn-default pull-left" data-dismiss="modal"><i
						class="fa fa-close"></i> Đóng</button>
				<button type="submit" class="btn btn-custon-four btn-success" name="edit"><i class="fa fa-check-square-o"></i>
					Cập nhật</button>
				</form>
			</div>
		</div>
