...
<head>
    ...
    <title>Các khoản khấu trừ - The Monkey Gallery</title>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="breadcome-list">
                                <ul class="breadcome-menu">
                                    ...
                                    <li><span class="bread-blod">Các khoản khấu trừ</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="sparkline13-list">
                           ...
                           ";
                                ...
                                <div class="main-sparkline13-hd">
                                    <h1>Khấu <span class="table-project-n">trừ</span></h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true"
                                        ...
                                        <thead>
                                            <tr>
                                                <th data-field="position">Mô tả</th>
                                                <th data-field="work-shift">Lượng tiền</th>
